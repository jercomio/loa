    ...
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        variant === "default"
          ...
          : "*:data-[slot=tabs-trigger]:hover:bg-background data-[orientation=horizontal]:py-1 data-[orientation=vertical]:px-1",
        className,
      )}
      {...props}
    >
      ...
      <TabsPrimitive.Indicator
        ...
        className={cn(
          ...
          variant === "underline"
            ...
            : "bg-background dark:bg-foreground/10 -z-1 rounded-md shadow-sm",
        )}
      />
    </TabsPrimitive.List>
  );
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "hover:text-muted-foreground data-selected:text-foreground data-selected:font-semibold",
